...
# Everything below this I've added - Keith
import kab_utils
...
def test_dataset(model, dataset, nr_images):
    ...
    for i in range(nr_images):
        ...
        image_path = dataset.image_ids[i] if nr_images == len(dataset.image_ids) else random.choice(dataset.image_ids)

        image, image_meta, gt_class_id, gt_bbox, gt_mask = \
            modellib.load_image_gt(dataset, config, image_path, use_mini_mask=False)
        info = dataset.image_info[image_path]
